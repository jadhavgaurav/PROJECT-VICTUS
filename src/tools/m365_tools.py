...
# Import from the M365 auth module
...
def send_email(to: str, subject: str, content: str = "") -> str:
    """
    Sends an email from the user's Microsoft Outlook account to a recipient. 
    Keywords: email, mail, send, outlook.
...
@tool
def get_calendar_events(days: int = 7, specific_date: Optional[str] = None) -> str:
    """
