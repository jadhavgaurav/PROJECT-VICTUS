document.addEventListener("DOMContentLoaded", () => {
  ...
  // The isNewSession flag is no longer needed
  if (!sessionId) {
  ...
  fileUpload.addEventListener("change", async () => {
    ...
    try {
      ...
      if (response.ok) {
        addMessageToChat(
          `Successfully uploaded and indexed "${file.name}". You can now ask questions about it.`,
          "ai"
        );
      } else {
  ...
  // ==============================================================================
  // === CORRECTED FEATURE: Load chat history on page start ===
  // ==============================================================================
  async function loadChatHistory() {
    ...
    try {
      ...
      // This is now much simpler: always clear the chat and render whatever the backend sends.
      ...
      addMessageToChat(
        "Welcome to VICTUS! I'm having trouble loading our past conversation, but I'm ready to help.",
        "ai"
      );
    }
  }
